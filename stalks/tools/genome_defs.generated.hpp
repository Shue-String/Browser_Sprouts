...
inline const std::vector<std::pair<std::string, GenomeDef>>& familyDefs() {
    ...
    {"S_19", {0, 0, {2}, {1}, {{"S_2", 0}, {"C_3", 0}}}},
    {"S_20", {0, 1, {0, 2}, {}, {{"C_3", 0}, {"S_1", 1}}}},
    {"S_21", {0, 3, {0, 1}, {}, {{"C_3", 0}, {"S_1", 1}}}},
    {"S_22", {0, 3, {0}, {}, {{"S_2", 0}, {"C_3", 0}, {"S_1", 1}}}},
    {"S_23", {0, 3, {2}, {1}, {{"S_2", 0}, {"C_3", 0}, {"S_1", 1}}}},
    {"S_24", {0, 3, {0, 1}, {}, {{"S_2", 0}, {"S_1", 1}, {"C_3", 0}}}},
    {"S_25", {0, 3, {0, 2}, {}, {{"S_2", 0}, {"C_3", 0}, {"S_1", 1}}}},
    {"S_26", {0, 3, {0, 1, 2}, {}, {{"S_2", 0}, {"C_3", 0}, {"S_1", 1}}}},
    };
    return kDefs;
}
