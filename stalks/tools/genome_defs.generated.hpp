...
inline const std::vector<std::pair<std::string, GenomeDef>>& familyDefs() {
    ...
    {"S_2", {1, 1, {0}, {0}, {}}},
    {"C_4", {1, 2, {1}, {0}, {{"S_1", 0}}}},
    {"S_5", {0, 1, {0, 2}, {}, {{"C_4", 0}, {"S_1", 1}}}},
    {"S_6", {0, 2, {0}, {}, {{"S_2", 0}, {"S_1", 1}}}},
    {"S_7", {0, 3, {0, 2}, {}, {{"S_2", 0}, {"S_1", 1}}}},
    {"S_8", {0, 3, {0}, {}, {{"S_2", 0}, {"C_4", 0}, {"S_1", 1}}}},
    {"S_9", {0, 3, {0, 2}, {}, {{"S_2", 0}, {"C_4", 0}, {"S_1", 1}}}},
    ...
    {"S_16", {0, 3, {2}, {1}, {{"S_2", 0}, {"C_4", 0}, {"S_1", 1}}}},
    {"S_17", {0, 3, {0, 1, 2}, {}, {{"S_2", 0}, {"C_4", 0}, {"S_1", 1}}}},
    {"S_18", {0, 3, {0, 1, 2}, {}, {{"S_2", 0}, {"S_1", 1}}}},
    {"S_19", {2, 3, {0, 2}, {}, {{"S_2", 0}, {"S_1", 0}, {"S_1", 1}}}},
    {"S_20", {0, 3, {0, 1}, {}, {{"C_4", 0}, {"S_1", 1}}}},
    };
    return kDefs;
}
